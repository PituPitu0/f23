...
const VideoPost = ({className, dark}) => {
  ...
  //  const [newLocal] = <iframe width="560" height="315" src="https://www.youtube.com/embed/hgnLkmEpvaA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
//    const newLocal = <img src={video1} alt="video1" />;
    return (
                                ...
                                <div className="post_img">
                                    <div className="img_wrap">
                                        <Link to="/" className="play_btn">
                                            ...
                                            src="https://www.youtube.com/embed/hgnLkmEpvaA" 
