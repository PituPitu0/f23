...
const VideoPostTwoHThreePage = () => {
    ...
    return (
        <Fragment>
            <MainMenuThree/>
            <div className="white_bg layout3">
                <div className="archives post post1 padding-top-30">
                        ...
                        <div className="row">
                            <div className="col-12 col-md-10 col-lg-8 m-auto">
                                <div className="video_img border-radious5">
                                    <Link onClick={(e) => openModalVideo(e, '0r6C3z3TEKw')} to="/" className="play_btn">
...
export default VideoPostTwoHThreePage;