                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-12 col-md-10 col-lg-8 m-auto">
                                ...
                                <div className="col-12">
                                    <div className="page_comments">
                                        <ul className="inline">
                                            ...
                                            <li><FontAwesome name="comment"/>536</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <p>A shortage of several hundred ventilators in New York City, the epicentre of the
                                outbreak in the US, prompted Mr Cuomo to say that he will order the machines be
                                taken from various parts of the state and give them to harder-hit areas.in New
                            ...
                            <div className="row">
                                <div className="col-12">
                                    <div className="qhote quote_type2 dark-2">
                            ...
                            <div className="space-40"/>
                            <PostOnePagination className="next_prv_single padding20 theme3_bg border-radious5 dark-2"/>
                        </div>
                    </div>
                </div>
            </div>
...
export default VideoPostTwoDarkPage;